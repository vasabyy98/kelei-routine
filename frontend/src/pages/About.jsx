      ...
      <section className={styles.content__wrapper}>
        ...
        <div className={styles.about__content}>
          <p>
            ...
            what might otherwise take 10 years might take only 5 years if approached properly. Keep
            in mind that my recommendations are strictly hypertrophy orientated, they don't apply to
            performance/sport specific goals.
          </p>
          <p>
          ...
          <p>
            ...
            should rotate through push, pull and leg workouts regardless of what day of the week it
            is, if your last workout was a pull workout your next workout should be a leg workout.
          </p>
          <p>
            If you take a day off you simply pick up from where you left off, I recommend a minimum
            of 3 training days per week for beginners, a minimum of 4 training days per week for
            intermediate lifters and a minimum of 5 training days per week for advanced lifters.
            Generally speaking the more days per week you can train the faster your progress will be
            because your average frequency and weekly volume will both be higher.
          </p>
          <p>
          ...
          <p>
            ...
            first set to failure (as many full reps as possible, not actually failing) and then rest
            long enough to allow 3-5 reps during each subsequent rest-pause set until you reach your
            total rep target, for example if your total rep target is 30 reps it might look like 10,
            5, 5, 5, 5. If you can perform more than 5 reps in your rest-pause sets you're simply
            resting too long between sets, if you can't perform at least 3 reps you're not resting
            long enough. Some people prefer 5 rep rest-pause sets for larger/compound exercises and
            3 rep rest-pause sets for smaller/isolation exercises, go with whatever feels best to
            you.
          </p>
          <p>
            You should add more weight once you can complete 12 reps in your first set, try not to
            let the reps drop below 8, this usually occurs when you add too much weight. You should
            use your first set of each exercise as your measure of progress. For small exercises
            like side lateral raises it's acceptable to add more weight once you can complete 15
            reps rather than only 12 reps, with calf exercises I recommend adding more weight once
            you can complete 20 reps in your first set.
          </p>
          <p>
            I also recommend lifting (concentric) as fast as possible, the weights won't necessarily
            move fast but you should still attempt to lift them as fast as possible, I recommend
            slowing down the eccentric (negative), not excessively but just enough to keep tension
            on the muscles.
          </p>
          <p>
            ...
            example, you can substitute exercises that don't agree with you or exercises you simply
            don't have the necessary equipment to perform.
          </p>
          <p>
          ...
          <p>
            ...
            reverse flyes/crossovers, tricep pressdowns, preacher curls, cable side lateral raises,
            front squats, Romanian deadlifts, leg extensions, leg curls, standing calf raises,
            seated calf raises.
          </p>
          <p>
            ...
            preacher curls, cable side lateral raises, front squats, Romanian deadlifts, leg press,
            hyperextensions, leg extensions, leg curls, standing calf raises, seated calf raises.
          </p>
          ...
          <p>
            These are only general guidelines, some of you might need even lower volume, some of you
          ...
          <p>
            ...
            should perform only your first set of each exercise, deloads serve to keep your body and
            mind fresh for the long haul, even if you don't feel as though you need to deload I
